...
public class HQL_query_between {
    ...
    public static void main(String[] args) {
        try {
            ...
            //Query listagem_query = sessao.createQuery("from Aluno where alu_codigo between 1  and 15");
            // listagem_query.setString("nome", "Jonas Martins");
            //ou 
            Query listagem_query = sessao.createQuery("from Aluno where alu_codigo between :codini and :codfinal ");
            listagem_query.setInteger("codini", 1);
            listagem_query.setInteger("codfinal", 10);
